      ...
      return (
        <div className="bg-background flex items-center justify-center p-4">
          <div className="max-w-md w-full space-y-4">
            ...
            {/* A plain anchor, not a react-router <Link>: the boundary can
                catch an error thrown above the router, where Link would have
                no context and throw again. A full navigation also discards
                the broken state this component is displaying. */}
            <a
              href="/issues"
